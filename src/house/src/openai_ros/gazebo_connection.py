...
class GazeboConnection():
    ...
    # 根据 self.reset_world_or_sim 参数的不同取值，选择不同的重置策略，
    def resetSim(self):
        """
    ...
    def resetSimulation(self):
        rospy.wait_for_service('/gazebo/reset_simulation') #Gazebo 仿真器自带的标准服务, 无需用户在代码中手动创建
        try:
    ...
    def resetRobot(self):
        ...
        robot_reset_request.model_state.model_name = 'mybot'
