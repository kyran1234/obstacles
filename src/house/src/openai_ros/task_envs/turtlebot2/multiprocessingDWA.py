...
def main():
	...
	while not rospy.is_shutdown():
		...
		odom1 = rospy.wait_for_message("/odom", Odometry, timeout=5.0)
		laser_scan1 = rospy.wait_for_message("/scan", LaserScan, timeout=5.0)
		
		odom2 = rospy.wait_for_message("/odom", Odometry, timeout=5.0)
		laser_scan2 = rospy.wait_for_message("/scan", LaserScan, timeout=5.0)

		odom3 = rospy.wait_for_message("/odom", Odometry, timeout=5.0)
		laser_scan3 = rospy.wait_for_message("/scan", LaserScan, timeout=5.0)

		odom4 = rospy.wait_for_message("/odom", Odometry, timeout=5.0)
		laser_scan4 = rospy.wait_for_message("/scan", LaserScan, timeout=5.0)
